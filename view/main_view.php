...
<?php
	if(isset($_SESSION['user_first_connected']) && $_SESSION['user_first_connected'] == 'did_connect') {
		echo '<div class="login_ok"> Vous êtes connecté ! </div>';
		$_SESSION['user_first_connected'] = 'forget_this';
	}
	elseif(isset($_SESSION['user_first_connected']) && $_SESSION['user_first_connected'] == 'did_try_to_connect_but_could_not') {
